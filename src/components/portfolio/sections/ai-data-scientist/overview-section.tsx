  ...
  return (
    <div className="space-y-12">
        <Card className="overflow-hidden">
            <div className="flex flex-col md:flex-row bg-card/50">
                ...
                <div className="md:w-2/3 p-8 flex flex-col justify-center">
                    <h2 className="text-2xl font-headline font-bold mb-2">A Message for the AI Data Scientist Profile</h2>
                    <p className="text-muted-foreground mb-4">
                        Welcome to my career portfolio. This unified view combines my skills across data analysis, engineering, and science to give you a comprehensive look at my capabilities as a versatile data professional with a focus on AI.
                    </p>
                    <p className="text-sm font-semibold">Chayan Agarwal</p>
                    <p className="text-xs text-muted-foreground">AI Data Scientist & Aviation Enthusiast</p>
                </div>
            </div>
        </Card>
        ...
        <Card className="bg-card/50">
            ...
            <CardContent>
                <p className="text-sm text-muted-foreground">Customized content for AI Data Scientist</p>
